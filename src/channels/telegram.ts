...
/**
 * Download a photo from Telegram and save it to the group's attachments directory.
 * Returns the container-side path (e.g. /workspace/group/attachments/foo.jpg) or null on failure.
 */
